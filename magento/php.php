...
$csvFilePath = 'pathtoproduct_data.csv';  Replace with the actual path to your CSV file
...
foreach ($csvData as $rowData) {
    ...
    $magmiCsvFilePath = 'pathtomagmi_data.csv';  Replace with the desired path and file name
    file_put_contents($magmiCsvFilePath, $magmiCsvData, FILE_APPEND);
}

 Use Magmi to import the product data
$magmiPath = 'pathtomagmi';  Replace with the actual path to your Magmi installation
$command = php {$magmiPath}magmi.cli.php -profile=your_profile_name -mode=create -CSVfilename={$magmiCsvFilePath};

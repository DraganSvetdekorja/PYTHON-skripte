...
def index():
    if request.method == 'POST':
        ...
        #styled = df.style.set_table_attributes('data-toggle="table"', 'id="table"', 'data-search="true"', 'data-show-multi-sort="true"')		
        #styled2 = styled1.style.set_table_attributes('table_id="podatki"')
		
        data = df.to_html(index=False, classes='table table-stripped')
        #tabelca2 = convert_to_table.style.set_table_attributes('data-toggle="table"')
